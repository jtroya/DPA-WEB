...
<?php wp_head(); ?>
<?php $metas=get_post_meta($post->ID,'_my_meta',true); ?>
			      ...
			      <div class="span8">
			      	...
			      	<div id="logos">
						...
						<hgroup>
							...
							<div id="breadcrumbs-ud">
								<i class="grado icondpa-grado"></i>
									<div class="ud icono">
									<?php 
										if ($metas['numero_ud'])  { 
							...
							<div id="blogname">
								<h1 id="site-title">
									<span id="site-title-ud">
										<?php if ($metas['nombre_corto_ud'])  { echo $metas['nombre_corto_ud']; } else { echo 'Unidad Docente'; } ?>
									</span> <br />
									proyectos en fundamentos<br />
									arquitect&oacute;nicos
								</h1>
							</div>
