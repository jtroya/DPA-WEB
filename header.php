...
<link rel="stylesheet" href="<?php bloginfo( 'template_url' ); ?>/font/icon-font-social/style.css" />
			      ...
			      <div class="span3">
			      	...
			      	<div id="logos">
						...
						<hgroup>
							...
							<div id="blogname"><h1 id="site-title">departamento <br />de proyectos<br />arquitectónicos</h1></div>
