...
<div class="my_meta_control"> 
    <p>
        <label >Abreviatura Número del Taller Propedeutico (Ej. 01, 02, gm 123, etc.)</label>
...
<div class="my_meta_control"> 
    <p>
        <label>Abreviatura Nombre del Taller Propedeutico (Ej. ud.nombre, gm.nombre, etc.)</label>
...
<div class="my_meta_control"> 
     <p>
        <label>Director del Taller</label>
...
<div class="my_meta_control"> 
    <p>
        <label style="padding-top:7px;">Miembros del Taller Propedeutico</label>
    </p>
...
<div class="my_meta_control">
    <p><label style="padding-top:7px;">Sitio web (Blog) (incluir "http://")</label></p>
