...
<div class="my_meta_control"> 
    <p>
        <label >Abreviatura Número (Ej. 01, 02, gm 123, etc.)</label>
...
<div class="my_meta_control"> 
    <p>
        <label>Abreviatura Nombre de la unid. Libre Configuración (Ej. lc.nombre, ud.nombre, gm.nombre, etc.)</label>
...
<div class="my_meta_control"> 
    <p>
        <label style="padding-top:7px;">Miembros</label>
    </p>
