		...
		<!-- <section id="primary"> -->
			<div id="content" role="main">	
				<header class="entry-header">
					<h1 class="entry-title">Aulas PFC</h1>
				</header>
				<div class="entry-content">
					<div class="row-fluid proyectos-box">
						...
						?>
						<div class="proyectos-title-box"><i class="punto">·</i><span>PFC</span></div>	
						...
						<?php else : ?>
							<article id="post-0" class="post no-results not-found">
								<header class="entry-header">
									<h1 class="entry-title"><?php _e( 'No existen Aulas PFC', 'toolbox' ); ?></h1>
								</header><!-- .entry-header -->
							</article><!-- #post-0 -->
						<?php endif; ?>
